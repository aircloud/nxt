...
(function(factory) {
  ...
  */
  ...
  _.extend(Model.prototype, Events, {
    ...
    //复制一个浅拷贝对象,这我就不明白了,为什么函数名叫toJSON, 毕竟也没有转化成JSON...
    ...
    /*
      ...
      另外,和服务端交互的这些函数中有很多地方用了wrapError,这个是处理错误的,我们会在最后提到它
    */
  ...
  */
  ...
  _.extend(Collection.prototype, Events, {
    ...
    /*
      collection的一个核心方法,内容很长,我们可以把它理解为重置:给定一组新的模型,增加新的,去除不在这里面的,混合已经存在的
  ...
  */
  ...
  //包装错误,非常典型的设计模式中的装饰者模式,这里增加了一个触发
