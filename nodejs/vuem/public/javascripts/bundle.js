	...
	var vm = new Vue({
	    ...
	    methods: {
	        showSideBar: function showSideBar() {
	            _dynamics2.default.animate(sideBar, {
	                left: -180
	            }, {
	            ...
	            if (this.sideBar) {
	                ...
	                if (parseFloat(sideBar.style.left) > -270) {
	                    _dynamics2.default.animate(sideBar, {
	                        ...
	                        type: _dynamics2.default.linear,
	                        duration: 1
	                    });
	                } else {
	                    this.sideBar = false;
	  ...
	  startAnimation = function(el, properties, options, timeoutId) {
	    ...
	    for (k in properties) {
	      ...
	      if ((el.style != null) && transformProperties.contains(k)) {
	        ...
	        if (interpolable instanceof InterpolableNumber && !(k in el) && (el.style != null)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/.npminstall/css-loader/0.24.0/css-loader/index.js!./../../node_modules/less-loader/index.js!./m.less", function() {
				var newContent = require("!!./../../node_modules/.npminstall/css-loader/0.24.0/css-loader/index.js!./../../node_modules/less-loader/index.js!./m.less");
