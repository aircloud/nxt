...
<div style="float: right;margin: 10px;">
    <span style="padding: 10px;font-size: 16px;font-weight: 500;"><?php  if(($_SESSION['name'])!='') echo "<a href=\"personal.php\">".$_SESSION['name']."</a>"; ?></span>
    <a><span style="padding: 10px;font-weight: 500;font-size: 16px;"><?php  if(($_SESSION['name'])!='') echo"<a href='exit.php' style='font-size:16px;'>退出</a>";else; ?></span></a>
    <a HREF="main.php"><span style="padding: 10px;font-weight: 500;font-size: 16px;">返回打印页</span></a>
